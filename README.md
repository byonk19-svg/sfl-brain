...
Durable product direction lives in [the product vision](docs/PRODUCT_VISION.md). A new maintainer or agent should also read the [latest dated handoff](docs/handoffs/2026-09-15-production-deployed-and-merged.md) and verify its time-sensitive claims.
