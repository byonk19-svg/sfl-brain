...
export default async function AddProductPage({ searchParams }: { searchParams: SearchParams }) {
  const params = await searchParams;
  const error = Array.isArray(params.error) ? params.error[0] : params.error;
  return (
    <div className="page-shell narrow-shell">
      <header className="page-header"><div><span className="eyebrow">Product catalog</span><h1>Add Product</h1><p>Add retailer and affiliate facts for content opportunities to use.</p></div></header>
      <Notice error={error} />
